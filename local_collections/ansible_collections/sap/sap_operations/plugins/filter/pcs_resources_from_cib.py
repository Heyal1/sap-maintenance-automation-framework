...
short_description: Get pcs resources list from result of sap.sap_operations.pcs_cib_info module
...
def pcs_resources_from_cib(  # noqa: C901
    data,
    id=None,
    id_contains=None,
...
class FilterModule(object):
    def filters(self):
        return {
            "pcs_resources_from_cib": pcs_resources_from_cib,
        }
