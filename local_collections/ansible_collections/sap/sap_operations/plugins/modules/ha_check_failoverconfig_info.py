...
DOCUMENTATION = r"""
---
module: ha_check_failoverconfig_info
...
short_description: Run sap host agent function HACheckFailoverConfig
...
RETURN = """
ha_check_failoverconfig_info:
    description: Result of HACheckFailoverConfig method execution on host with SAP HANA installed
    type: list
    elements: dict
    returned: success
    sample: |
...
EXAMPLES = """
- name: Run ha_check_failoverconfig_info
  sap.sap_operations.ha_check_failoverconfig_info:
    instance_number: "00"
"""
...
def main():
    ...
    try:
        ...
        ha_check_failoverconfig_info = convert2ansible(
            instance_sapcontrol.client.service.HACheckFailoverConfig()
        )

        module.exit_json(
            ha_check_failoverconfig_info=ha_check_failoverconfig_info,
        )
